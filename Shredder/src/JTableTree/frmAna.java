...
public class frmAna {
	...
	public frmAna(String path) {
		...
		cPane.add(new JScrollPane(treeTable),BorderLayout.CENTER);
	...
	protected void addButtons(JToolBar toolBar) {
		...
		btnRemoveFile.setIcon(new ImageIcon(getClass().getResource("/com/sun/javafx/scene/web/skin/DrawHorizontalLine_16x16_JFX.png")));
	...
	protected void updateStatusLabel() {
		if (reloadPath != null) {
			...
			statusLabel
					.setText("Total Size: " + NumberFormat.getInstance().format(model.getTotalSize(model.getRoot())));
